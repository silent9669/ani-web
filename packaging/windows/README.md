...
Download the latest `ani-desk_<version>_x64-setup.exe` from the GitHub Release and run it.
...
For MSI validation or enterprise-style install testing, use the release `ani-desk_<version>_x64.msi` artifact or run the helper with `-Msi`.
